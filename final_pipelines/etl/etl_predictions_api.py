...
sql_h2h_source_path=os.path.join(path, 'sql/create_h2h_source_predictions.sql')
sql_insert_source=os.path.join(path, 'sql/insert_h2h_source_predictions.sql')

###############################################
## API CALL: ALL MATCHES IN FUTURE 7 DAYS
############################################### 
